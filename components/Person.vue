<template>
  <v-list>
    <v-list-item v-if="model.personId" title="Persion ID" :subtitle="model.personId" />
    <v-list-item
      v-if="model.electronicAddress"
      title="Email"
      :subtitle="model.electronicAddress"
    />
    ...
    <PureSearch v-model="model.personName" />
  </v-list>
</template>
